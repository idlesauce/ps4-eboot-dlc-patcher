...
#define SCE_APP_CONTENT_ADDCONT_DOWNLOAD_STATUS_NO_EXTRA_DATA (0)

#define SCE_APP_CONTENT_ADDCONT_DOWNLOAD_STATUS_NO_IN_QUEUE (1)

#define SCE_APP_CONTENT_ADDCONT_DOWNLOAD_STATUS_DOWNLOADING (2)

#define SCE_APP_CONTENT_ADDCONT_DOWNLOAD_STATUS_DOWNLOAD_SUSPENDED (3)
